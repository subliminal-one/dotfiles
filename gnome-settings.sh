...
gsettings set $KEYS switch-to-workspace-1 "['<Super>1','<Super>i']"
gsettings set $KEYS switch-to-workspace-2 "['<Super>2', '<Super>o']"
gsettings set $KEYS switch-to-workspace-3 "['<Super>3', '<Super>p']"
...
gsettings set $KEYS move-to-workspace-1 "['<Super><Shift>1', '<Super><Shift>i']"
gsettings set $KEYS move-to-workspace-2 "['<Super><Shift>2', '<Super><Shift>o']"
gsettings set $KEYS move-to-workspace-3 "['<Super><Shift>3', '<Super><Shift>p']"

...
gsettings set $KEYS switch-applications-backward "['<Shift><Super>Tab','<Shift><Alt>Tab','<Shift><Super>l']"
gsettings set $KEYS switch-group "['<Super>Above_Tab','<Alt>Above_Tab','<Super>k']"

gsettings set $MUTTER switch-monitor "['XF86Display']"
gsettings set $KEYS switch-to-workspace-1 "['<Super>1','<Super>u']"
gsettings set $KEYS switch-to-workspace-2 "['<Super>2', '<Super>i']"
gsettings set $KEYS switch-to-workspace-3 "['<Super>3', '<Super>o']"
gsettings set $KEYS switch-to-workspace-4 "['<Super>4', '<Super>p']"
...
gsettings set $KEYS move-to-workspace-1 "['<Super><Shift>1', '<Super><Shift>u']"
gsettings set $KEYS move-to-workspace-2 "['<Super><Shift>2', '<Super><Shift>i']"
gsettings set $KEYS move-to-workspace-3 "['<Super><Shift>3', '<Super><Shift>o']"
gsettings set $KEYS move-to-workspace-4 "['<Super><Shift>4', '<Super><Shift>p']"
...
gsettings set "org.gnome.mutter.keybindings" toggle-tiled-left "['<Super><Shift>j']"
gsettings set "org.gnome.mutter.keybindings" toggle-tiled-right "['<Super><Shift>colon']"
